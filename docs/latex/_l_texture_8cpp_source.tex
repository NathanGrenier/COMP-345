...
=======
\DoxyCodeLine{00009\ \ \ \ \ mTexture\{\ nullptr\ \},}
\DoxyCodeLine{00010\ \ \ \ \ mWidth\{\ 0\ \},}
\DoxyCodeLine{00011\ \ \ \ \ mHeight\{\ 0\ \}\ \{}
>>>>>>> origin/master
\DoxyCodeLine{00012\ }
\DoxyCodeLine{00013\ \}}
\DoxyCodeLine{00014\ }
...
\DoxyCodeLine{00108\ \ \ \ \ \textcolor{comment}{//\ Default\ to\ clip\ dimensions\ if\ clip\ is\ given}}
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keywordflow}{if}\ (clip\ !=\ \textcolor{keyword}{nullptr})\ \{}
\DoxyCodeLine{00110\ \ \ \ \ \ \ \ \ dstRect.w\ =\ clip-\/>w;}
\DoxyCodeLine{00111\ \ \ \ \ \ \ \ \ dstRect.h\ =\ clip-\/>h;}
\DoxyCodeLine{00112\ \ \ \ \ \}}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00114\ \ \ \ \ \textcolor{comment}{//\ Calculate\ the\ aspect\ ratio\ of\ the\ texture}}
\DoxyCodeLine{00115\ \ \ \ \ \textcolor{keywordtype}{float}\ aspectRatio\ =\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{float}\textcolor{keyword}{>}(\mbox{\hyperlink{class_l_texture_ac6b5edfd40c81b2b40b71b12e7da2b6f}{mWidth}})\ /\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{float}\textcolor{keyword}{>}(\mbox{\hyperlink{class_l_texture_aea944f7b207bb9e8b57870d6bd3b5e05}{mHeight}});}
\DoxyCodeLine{00116\ }
\DoxyCodeLine{00117\ \ \ \ \ \textcolor{comment}{//\ Resize\ while\ maintaining\ aspect\ ratio\ if\ necessary}}
\DoxyCodeLine{00118\ \ \ \ \ \textcolor{keywordflow}{if}\ (width\ >\ 0\ \&\&\ height\ <=\ 0)\ \{}
\DoxyCodeLine{00119\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Only\ width\ is\ provided,\ calculate\ height\ based\ on\ aspect\ ratio}}
\DoxyCodeLine{00120\ \ \ \ \ \ \ \ \ dstRect.w\ =\ width;}
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ dstRect.h\ =\ dstRect.w\ /\ aspectRatio;}
\DoxyCodeLine{00122\ \ \ \ \ \}}
\DoxyCodeLine{00123\ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (height\ >\ 0\ \&\&\ width\ <=\ 0)\ \{}
\DoxyCodeLine{00124\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Only\ height\ is\ provided,\ calculate\ width\ based\ on\ aspect\ ratio}}
\DoxyCodeLine{00125\ \ \ \ \ \ \ \ \ dstRect.h\ =\ height;}
\DoxyCodeLine{00126\ \ \ \ \ \ \ \ \ dstRect.w\ =\ dstRect.h\ *\ aspectRatio;}
\DoxyCodeLine{00127\ \ \ \ \ \}}
\DoxyCodeLine{00128\ \ \ \ \ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00129\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ If\ both\ width\ and\ height\ are\ provided,\ use\ them\ directly}}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (width\ >\ 0)\ dstRect.w\ =\ width;}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (height\ >\ 0)\ dstRect.h\ =\ height;}
\DoxyCodeLine{00132\ \ \ \ \ \}}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \ \ \textcolor{comment}{//\ Render\ texture\ with\ the\ updated\ dimensions}}
\DoxyCodeLine{00135\ \ \ \ \ SDL\_RenderTextureRotated(\mbox{\hyperlink{_global_8h_a4735638969a524c4ac90a88f23c59a1f}{gRenderer}},\ \mbox{\hyperlink{class_l_texture_a98d76cf42f620b9c2eacd7b71c3c0c2f}{mTexture}},\ clip,\ \&dstRect,\ degrees,\ center,\ flipMode);}
\DoxyCodeLine{00136\ \}}
\DoxyCodeLine{00137\ }
\DoxyCodeLine{00138\ }
\DoxyCodeLine{00139\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{class_l_texture_a542c1f81d98fd5659a04eb394d61a879}{LTexture::getWidth}}()\ \{}
\DoxyCodeLine{00140\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_l_texture_ac6b5edfd40c81b2b40b71b12e7da2b6f}{mWidth}};}
\DoxyCodeLine{00141\ \}}
\DoxyCodeLine{00142\ }
\DoxyCodeLine{00143\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{class_l_texture_a277f45af3dae7e35ca846a527039e59a}{LTexture::getHeight}}()\ \{}
\DoxyCodeLine{00144\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{class_l_texture_aea944f7b207bb9e8b57870d6bd3b5e05}{mHeight}};}
\DoxyCodeLine{00145\ \}}
>>>>>>> origin/master
